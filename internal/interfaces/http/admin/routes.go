...
func RegisterRoutes(r *gin.Engine, cfg platform.Config, postSvc domain.PostService, adminSvc domain.AdminService, taxonomySvc domain.TaxonomyService, loginLimiter, registerLimiter gin.HandlerFunc) {
	...
	registerContentRoutes(adminGroup, postSvc, taxonomySvc)
}
